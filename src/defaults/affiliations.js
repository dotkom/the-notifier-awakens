  ...
  online: {
    ...
    components: [
      ...
      },
      {
        ...
        count: '{{busCount}}',
        apis: {
          fromCity: '{{busApi}}.stops.{{bus:glos}}.fromCity:departures',
          toCity: '{{busApi}}.stops.{{bus:glos}}.toCity:departures',
        },
      },
      {
        template: 'Bus',
        ...
        count: '{{busCount}}',
        apis: {
          fromCity: '{{busApi}}.stops.{{bus2:prof}}.fromCity:departures',
          toCity: '{{busApi}}.stops.{{bus2:prof}}.toCity:departures',
        },
      },
      {
        template: 'Office',
